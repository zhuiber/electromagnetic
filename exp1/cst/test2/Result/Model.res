...
lifetime=s:rebuild
result=s:1
files=s:E-Field (Es)_Abs (Z)_1.rd1
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Es Solver\Energy\component1\solid1
files=s:EsSolver_Energy_component1_solid1.0d
...
result=s:1
treepath=s:Tables\1D Results\E-Field (Es)_Abs (Z)
files=s:E-Field (Es)_Abs (Z).rt1
files=s:E-Field (Es)_Abs (Z).rd1
title=s:E-Field (Es)_Abs (Z)
xlabel=s:Z / mm
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\1D Results\E-Field (Es)_Abs (Z)_1
files=s:E-Field (Es)_Abs (Z)_1.rt1
files=s:E-Field (Es)_Abs (Z)_1.rd1
title=s:E-Field (Es)_Abs (Z)_1
xlabel=s:Z / mm
