...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Es Solver\Energy\component1\solid2
files=s:EsSolver_Energy_component1_solid2.0d
...
result=s:1
treepath=s:Tables\1D Results\E-Field (Es)_Abs (X)
files=s:E-Field (Es)_Abs (X).rt1
files=s:E-Field (Es)_Abs (X).rd1
title=s:E-Field (Es)_Abs (X)
xlabel=s:X / mm
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\1D Results\D-Field (Es)_Abs (X)
files=s:D-Field (Es)_Abs (X).rt1
files=s:D-Field (Es)_Abs (X).rd1
title=s:D-Field (Es)_Abs (X)
xlabel=s:X / mm
